...
public class ApiConstants {
    ...
    public static final String SERVER_URL = "http://132.72.50.53:8081"; // TEST environment - use ConfigManager.getServerUrl()
    public static final String API_BASE_URL = "http://132.72.50.53:8081/api/v1"; // TEST environment
