...
public class SeminarService {
    ...
    public Seminar createSeminar(Seminar seminar) {
        ...
        try {
            ...
            Optional<User> presenter = userRepository.findByUserId(seminar.getPresenterId());
    ...
    public Optional<Seminar> getSeminarById(String seminarId) {
        ...
        try {
            Optional<Seminar> seminar = seminarRepository.findBySeminarId(seminarId);
    ...
    public Seminar updateSeminar(String seminarId, Seminar updatedSeminar) {
        ...
        try {
            Optional<Seminar> existingSeminar = seminarRepository.findBySeminarId(seminarId);
            ...
            if (updatedSeminar.getPresenterId() != null) {
                ...
                Optional<User> presenter = userRepository.findByUserId(updatedSeminar.getPresenterId());
