...
# New password - REPLACE WITH ACTUAL PASSWORD
NEW_PASSWORD="${SPRING_MAIL_PASSWORD:-your-password-here}"
NEW_USERNAME="${SPRING_MAIL_USERNAME:-your-email@bgu.ac.il}"
NEW_FROM="${SPRING_MAIL_FROM:-SemScan_System_NoReply@bgu.ac.il}"
